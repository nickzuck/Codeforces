// Located at :http://pastebin.com/YyKsYUTa
...
struct point {
	...
	point(ll x, ll y, int id) : x(x), y(y), id(id) { // Initializes point:x, point:y, point:id to the value of parameters x, y and id respectively
		pv = atan2(y, x);
